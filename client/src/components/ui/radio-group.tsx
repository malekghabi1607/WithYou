 ...
 * Basé sur Radix UI pour la gestion de l’état et l’accessibilité.
 *
 * Composants inclus :
 *  - RadioGroup : conteneur principal du groupe
 *  - RadioGroupItem : bouton radio individuel
 *
 * Caractéristiques :
 *  - Un seul choix possible
 *  - Gestion automatique du focus et du clavier
 *  - Styles personnalisés avec Tailwind CSS
 *  - Icône d’indication avec Lucide
 *
