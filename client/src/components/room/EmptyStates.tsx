/**
 * Projet : WithYou
 * Fichier : components/room/EmptyState.tsx
 *
 * Description :
 * Composant générique d’état vide utilisé dans les salons.
 * Il affiche un message et une icône lorsque certaines données
 * ne sont pas encore disponibles (playlist, chat, participants, salons).
 *
 * Objectif :
