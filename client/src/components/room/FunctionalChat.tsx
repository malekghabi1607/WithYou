/**
 * Projet : WithYou
 * Fichier : components/room/FunctionalChat.tsx
 *
 * Description :
 * Composant de chat en temps réel utilisé dans un salon de visionnage.
 * Il permet aux participants d’échanger des messages textuels et des emojis
 * pendant la lecture d’une vidéo.
 *
 * Fonctionnalités principales :
 * - Affichage de la liste des messages
 * - Envoi de messages texte
 * - Réactions rapides via emojis
 * - Défilement automatique vers le dernier message
 * - Désactivation du chat selon les permissions
 *
 * Objectif :
 * - Favoriser l’interaction entre les participants
 * - Créer une expérience sociale autour du visionnage
 * - Respecter les permissions définies par l’administrateur du salon
 */
