/**
 * Projet : WithYou
 * Fichier : components/settings/RoomPlaylistSettings.tsx
 *
 * Description :
 * Composant permettant de gérer la playlist d’un salon.
 * Il permet d’ajouter, supprimer et lancer des vidéos
 * afin de contrôler le contenu visionné par les participants.
 */
...
export function RoomPlaylistSettings({ roomId }: RoomPlaylistSettingsProps) {
  ...
  const handleAddVideo = () => {
    ...
    const newVideo: Video = {
      ...
      url: newVideoUrl,
      thumbnail:
        "https://images.unsplash.com/photo-1758686254041-88d7b6ecee8f?w=400",
      duration: "0:00",
      addedBy: "Vous"
    };
