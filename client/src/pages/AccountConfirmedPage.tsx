/**
 * AccountConfirmedPage Component
 * ------------------------------
 * Cette page confirme à l’utilisateur que son compte a été activé
 * avec succès après la validation (email ou inscription).
 *
 * Fonctionnalités principales :
 * - Affichage d’un message de confirmation de création de compte
 * - Bouton permettant de rediriger vers la page de connexion
 * - Présentation des principales fonctionnalités de l’application
 * - Gestion du thème clair / sombre (light / dark)
 *
 * Comportement :
 * - L’utilisateur arrive sur cette page après avoir confirmé son compte
 * - Un message rassurant confirme l’activation du compte
 * - Le bouton principal redirige vers la page de connexion
 *
 * UI / UX :
 * - Interface moderne, claire et rassurante
 * - Icône de succès pour renforcer le feedback utilisateur
