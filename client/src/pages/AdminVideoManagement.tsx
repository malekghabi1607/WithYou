/**
 * Projet : WithYou
 * Fichier : pages/AdminVideoManagement.tsx
 *
 * Description :
 * Composant de gestion des vidéos du salon côté administrateur.
 *
 * Il permet :
 *  - d’ajouter des vidéos via une URL
 *  - de rechercher et filtrer les vidéos
 *  - de lancer une vidéo pour tous les membres du salon
 *  - de supprimer une vidéo de la playlist
 *
 * Ce composant sert de panneau d’administration
 * pour gérer la playlist vidéo d’un salon.
 */
