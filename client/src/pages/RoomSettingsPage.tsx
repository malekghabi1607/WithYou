/**
 * Projet : WithYou
 * Fichier : pages/RoomSettingsPage.tsx
 *
 * Description :
 * Page dédiée à la configuration complète d’un salon de visionnage.
 * 
 * Cette page est accessible uniquement aux utilisateurs autorisés
 * (créateur ou administrateurs du salon).
 *
 * Elle est organisée sous forme d’onglets afin de séparer clairement
 * les différentes catégories de paramètres :
 *  - Informations générales du salon (nom, description, visibilité)
 *  - Permissions et règles d’accès
 *  - Gestion des membres et des rôles
 *  - Configuration de la playlist vidéo
 *  - Gestion des sondages et interactions
 *
